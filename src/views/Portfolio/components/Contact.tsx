...
const Contact = () => {
    return (
        <div className="tab_item hidden bg-slate-50 dark:bg-[#111111] rounded-xl mb-14">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            ...
                            <p className="inline-flex flex-col gap-1">
                                <a
                                    className="text-gray-lite text-lg dark:text-[#A6A6A6] "
                                    href="mailto:ibthemes@gmail.com"
                                >
                                    ibthemes@gmail.com
                                </a>
                                <a
                                    className="text-gray-lite text-lg dark:text-[#A6A6A6] "
                                    href="mailto:mailto:xyz@abc.com"
                                >
                                    mailto:xyz@abc.com
                                </a>
                            </p>
